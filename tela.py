...
class Janela():
    ...
    def primeira_tela(self):
        ...
        return sg.Window("Diario", layout, enable_close_attempted_event=self.saida, size=self.area,
                         element_justification='center', icon=iconDiario, font=self.fonte, finalize=True)
    ...
    def cadastro(self):
        ...
        return sg.Window('Diário', layout, enable_close_attempted_event=self.saida, size=self.area,
                                     text_justification='right', element_justification='center', icon=iconDiario,
                                     font=self.fonte, finalize=True)
    ...
    def area_usuario(self, nome=None):
        ...
        return sg.Window('Diário', layout, size=self.area, icon=iconDiario, enable_close_attempted_event=self.saida,
                         font=self.fonte, finalize=True)
    ...
    def escrever(self):
        ...
        return sg.Window('Diário', layout, size=self.area, element_justification='center', icon=iconDiario,
                                     enable_close_attempted_event=self.saida, font=self.fonte, finalize=True)
    ...
    def ler(self, lista):
        ...
        return sg.Window(self.nome, layout, size=self.area, enable_close_attempted_event=self.saida,
                                icon=iconDiario, font=self.fonte, finalize=True)
